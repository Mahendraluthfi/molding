            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo base_url('output') ?>">Output Record</a></li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">                        
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col">
                                    <h5>Result Date, <?php echo $date ?></h5>
                                </div>
                            ...
                            <div class="tab-content">
                                ...
                                <a href="<?php echo base_url('output/download/1/'.$datelink) ?>" class="btn btn-primary" target="_blank"><i class="zmdi zmdi-print"></i> Print PDF</a>                                
                                ...
                                <a href="<?php echo base_url('output/download/2/'.$datelink) ?>" class="btn btn-primary" target="_blank"><i class="zmdi zmdi-print"></i> Print PDF</a>                                
                                ...
                                <a href="<?php echo base_url('output/download/3/'.$datelink) ?>" class="btn btn-primary" target="_blank"><i class="zmdi zmdi-print"></i> Print PDF</a>                                
